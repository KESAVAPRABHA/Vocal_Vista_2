...
import { SpeechRecognition, SpeechSynthesis } from 'react-native-speech-recognition'; 

const SpeechTherapyGame = () => {
  ...
  const checkPronunciation = (userSpeech) => {
    const correctWord = pronunciationWords[currentWordIndex].toLowerCase();
...
export default SpeechTherapyGame;
